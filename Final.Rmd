...
Since there are new typos, we just need to adjust our misspellings list to account for these. Note, we use the '\\b' encasings to denote we want to only replace the value when it matches exacly that spelling.
...
Now that our data is cleaned and variables match eachother, we can begin visualizing the data.
